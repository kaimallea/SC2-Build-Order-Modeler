...
BuildOrder.prototype.validate = function(x) {
    ...
    // been built?
    //
    if (o.hasOwnProperty("build_from"))  { // unit-only property
        unit = true; // Set flag to prevent another lookup below
    ...
    // structures
    //
    if (!unit && this.race == "protoss" && x !== "Pylon" && 
